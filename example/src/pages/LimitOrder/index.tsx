...
function Gelato({ children }: { children?: React.ReactNode }) {
  ...
  return (
    <GelatoProvider
      ...
      factory={"0x5757371414417b8C6CAad45bAeF941aBc7d3Ab32".toLowerCase()}
      initCodeHash={"0x96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f".toLowerCase()}
