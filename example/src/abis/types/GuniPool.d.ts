...
interface GuniPoolInterface extends ethers.utils.Interface {
  functions: {
  ...
  events: {
    ...
    "Rebalance(int24,int24)": EventFragment;
...
export type RebalanceEvent = TypedEvent<
  [number, number] & { lowerTick_: number; upperTick_: number }
>;
...
export type UpdateAdminTreasuryEvent = TypedEvent<
  [string, string] & { oldAdminTreasury: string; newAdminTreasury: string }
>;
...
export class GuniPool extends BaseContract {
  ...
  filters: {
    ...
    "Rebalance(int24,int24)"(
      lowerTick_?: null,
      upperTick_?: null
    ): TypedEventFilter<
      [number, number],
      { lowerTick_: number; upperTick_: number }
    >;
