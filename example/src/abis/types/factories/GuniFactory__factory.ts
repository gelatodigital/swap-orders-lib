...
import type { GuniFactory, GuniFactoryInterface } from "../GuniFactory";
...
export class GuniFactory__factory {
  static readonly abi = _abi;
  static createInterface(): GuniFactoryInterface {
    return new utils.Interface(_abi) as GuniFactoryInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): GuniFactory {
    return new Contract(address, _abi, signerOrProvider) as GuniFactory;
  }
}
