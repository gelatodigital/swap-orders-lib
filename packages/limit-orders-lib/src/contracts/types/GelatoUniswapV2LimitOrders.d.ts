...
interface GelatoUniswapV2LimitOrdersInterface extends ethers.utils.Interface {
  functions: {
...
export class GelatoUniswapV2LimitOrders extends BaseContract {
  ...
  interface: GelatoUniswapV2LimitOrdersInterface;
